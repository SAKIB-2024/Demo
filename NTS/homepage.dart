      ...
      floatingActionButton: SizedBox(
        ...
        child: FloatingActionButton(
          onPressed: () async {
            ...
            _loadProducts(); // refresh after upload
          },
          backgroundColor: primaryColor,
          elevation: 8,
          ...
          child: Column(
            ...
            children: [
              ...
              if (product.freeDelivery)
                Row(children: [
                  Icon(Icons.local_shipping, size: 12, color: Colors.green.shade700),
                  const SizedBox(width: 2),
                  Text('FREE', style: TextStyle(fontSize: 10, color: Colors.green.shade700, fontWeight: FontWeight.w500)),
                ]),
